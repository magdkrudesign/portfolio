  ...
  return (
    <>
      ...
      <div style={{ display: "flex", gap: 8, alignItems: "flex-start" }}>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: 8 }}>
          ...
          <img
            ...
            alt="Magdalena Kruk"
            style={{ width: "100%", aspectRatio: "0.758", objectFit: "cover", objectPosition: "top", display: "block" }}
          />
          <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
            <span className="text-14">Senior Brand &amp; Product Designer</span>
            <span className="text-14" style={{ color: "var(--color-gray)" }}>Based in Wrocław, Poland</span>
          </div>
        </div>
      </div>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
        ...
        <a href="https://www.linkedin.com/in/magdalenakruk/" target="_blank" rel="noopener noreferrer"
          className="text-14" style={{ textDecoration: "none", color: "var(--color-gray)" }}>
          LinkedIn
        </a>
      </div>
    </>
  ...
  return (
    <PageLayout left={<LeftCol />} right={<RightCol />}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline",
          paddingBottom: 8, borderBottom: "1px solid rgb(230,230,230)", marginBottom: 12 }}>
